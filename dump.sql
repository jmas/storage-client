...
INSERT INTO `photos` VALUES (1,'http://picsdesktop.net/summer/1920x1440/PicsDesktop.net_5.jpg','photo 1');
...
INSERT INTO `posts` VALUES (1,'Good morning',2),(2,'Bye',2),(3,'Good morning',2),(4,'Good morning',2),(5,'Good morning',2);
...
INSERT INTO `postsUsers` VALUES (1,1),(1,2),(2,1);
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(1000) DEFAULT NULL,
  `second_name` varchar(1000) DEFAULT NULL,
  `photo` int(100) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'test2','test2',0),(2,'test3','test4',0),(3,'test','test',0),(4,'test5','test5',0),(5,'www','www',1),(6,'trs','tesdf',0);
...
-- Dump completed on 2014-08-05 11:20:00
